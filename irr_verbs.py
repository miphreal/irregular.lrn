...
words = [
	...
	u'говорить', 'say-said-said',
	u'видеть', 'see-saw-seen',
	u'отправлять', 'send-sent-sent',
	u'продавать', 'sell-sold-sold',
	u'ставить', 'set-set-set',
	u'трясти', 'shake-shook-shaken',
	u'сиять', 'shine-shone-shone',
	u'стрелять', 'shoot-shot-shot',
	u'показывать', 'show-showed-shown',
	u'закрывать', 'shut-shut-shut',
	u'петь', 'sing-sang-sung',
	u'тонуть', 'sink-sank-sunk',
	u'сидеть, садиться', 'sit-sat-sat',
	u'спать', 'sleep-slept-slept',
	u'скользить', 'slide-slid-slid',
	u'пахнуть, чувствовать запах', 'smell-smelt/smelled-smelt/smelled',
]
